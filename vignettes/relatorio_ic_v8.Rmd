...
emas_sel <-
  ...
  #readRDS('../../jbc-ic/data_saves/summary_80.rds') %>%
  dplyr::select(site, state, name, start, period, lat, lon, alt) %>%
  arrange(start, site)

# Scripts
source('../R/relatorio_fun.R')
...
# Metadados
summary_link <- "../../jbc-ic/data_saves/summary_80.rds"
...
![](../images/img_disponibilidade.png)
...
<p style='text-align: justify;'>
[dplyr](#dplyr) (WICKHAM, 2017), [DT](#DT) (XIE, 2016), [ggplot2](#ggplot2) (WICKHAM, 2016), [kableExtra](#kableExtra) (ZHU, 2017), [knitr](#knitr) (XIE, 2017), [lubridate](#lubridate) (GROLEMUND, 2016), [magrittr](#magrittr) (BACHE; WICKHAM, 2014), [openair](#openair) (CARSLAW; ROPKINS, 2017), [padr](#padr) (THOEN, 2017), [plyr](#plyr) (WICKHAM, 2016), [raster](#raster) (HIJMANS, 2016), [rio](#rio) (CHAN; CH CHAN; LEEPER; BECKER, 2018), [scales](#scales) (WICKHAM, 2017), [stringr](#stringr) (WICKHAM, 2017), [tidyverse](#tidyverse) (WICKHAM, 2017).
</p>
...
qc_list <- c(
  ...
  "_(QC5) Teste de Consistência Espacial_")
...
eq_list <- c(
  ...
  "$T_{avg}(d)' - fs'$ > $T_{avg}(d)$ > $T_{avg}(d)' + fs'$ ")
...
$T_{avg}(d)'$ é a estimativa não ponderada, obtida através do erro padrão de estimativa (s);
$s'$ é erro padrão ponderado da estimativa;
$f$ é um fator, cujo valor é 3.
...
# test_name <- 'Limites do Intervalo de Variação';
# test_type <- "daily";
# summary_link <- "../../jbc-ic/data_saves/summary_80.rds";
# #product3_link <- '../../jbc-ic/output/qc1a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds'; # 0 suspect
# #product3_link <- '../../jbc-ic/output/qc4a-summary-tavg-12h-data-inmet-2008-2016-4yrs-south.rds'; # 1 suspect
# product3_link <- '../../jbc-ic/output/qc1b-summary-tavg-data-inmet-2008-2016-4yrs-south.rds'; ## 66 suspects
# 
# rio::import(product3_link)
# 
# df = bind_rows(
#   rio::import(product3_link) %>% filter(site != 'A851'),
#   rio::import(product3_link) %>% filter(site == 'A845') %>% mutate(site = "A851")) %>%
#   arrange(desc(tot))
```
...
text.suspect(
  ...
  product3_link = '../../jbc-ic/output/qc1a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc1b-summary-tavg-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(b)__ A aplicação do teste de Limites do Intervalo de Variação 'b' nas 80 EMAs selecionadas gerou 66 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.1006% (≈ 79 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A845 – Morro Da Igreja (Bom Jardim Da Serra) (SC), com 2.1872% (1726 horas) ([Tabela 03](#Tabela 03)).
</p>
...
t02 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc1b-summary-tavg-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
# (100/78912) * (mean((readRDS("../../jbc-ic/output/qc1b-summary-tavg-data-inmet-2008-2016-4yrs-south.rds") %>% arrange(desc(perc)))[[4]], na.rm = TRUE))
...
```{r, eval=FALSE, message=FALSE, echo=FALSE}
text.suspect(
  test_name = "Persistência Temporal",
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc2a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(a)__ A aplicação do teste de Persistência Temporal 'a' nas 80 EMAs selecionadas gerou 80 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 4.6418% (≈ 3663 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A834 – Tramandaí (RS), com 9.446% (7454 horas) ([Tabela 04](#Tabela 04)).
</p>
...
t03 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc2a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
```{r, eval=FALSE, message=FALSE, echo=FALSE}
text.suspect(
  test_name = "Consistência Interna",
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc3a-summary-tmin-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(a)__ A aplicação do teste de Consistência Interna 'a' nas 80 EMAs selecionadas gerou 80 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.1511% (≈ 119 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A851 – Itapoá (SC), com 0.6818% (538 horas) ([Tabela 05](#Tabela 05)).
</p>
...
t04 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc3a-summary-tmin-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc3b-summary-tinst-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(b)__ A aplicação do teste de Consistência Interna 'b' nas 80 EMAs selecionadas gerou 12 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.0062% (≈ 5 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A880 – Vacaria (RS), com 0.0558% (44 horas) ([Tabela 06](#Tabela 06)).
</p>
...
t05 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc3b-summary-tinst-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc3c-summary-tavg-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(c)__ A aplicação do teste de Consistência Interna 'c' nas 80 EMAs selecionadas gerou 45 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.0769% (≈ 61 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A845 – Morro Da Igreja (Bom Jardim Da Serra) (SC), com 1.0657% (841 horas) ([Tabela 07](#Tabela 07)).
</p>
...
t06 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc3c-summary-tavg-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "daily",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc3d-summary-tavg-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
...
text.suspect(
  ...
  test_type = "daily",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc3e-summary-tmax-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(e)__ A aplicação do teste de Consistência Interna 'e' nas 80 EMAs selecionadas gerou 57 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.135% (≈ 4 dias), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A807 – Curitiba (PR), com 0.6083% (20 dias) ([Tabela 08](#Tabela 08)).
</p>
...
t07 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc3e-summary-tmax-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "days",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "daily",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc3f-summary-tmin-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(f)__ A aplicação do teste de Consistência Interna 'f' nas 80 EMAs selecionadas gerou 69 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.0908% (≈ 3 dias), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A851 – Itapoá (SC), com 0.3954% (13 dias) ([Tabela 09](#Tabela 09)).
</p>
...
t08 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc3f-summary-tmin-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "days",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc4a-summary-tavg-01h-data-inmet-2008-2016-4yrs-south.rds')
```
<p style='text-align: justify;'>
+ Para 1 hora: A aplicação do teste de Consistência Temporal 'a' nas 80 EMAs selecionadas gerou 80 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.2705% (≈ 213 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A875 – General Carneiro (PR), com 2.0276% (1600 horas) ([Tabela 10](#Tabela 10)).
</p>
...
t09 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc4a-summary-tavg-01h-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc4a-summary-tavg-02h-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
+ Para 2 hora: A aplicação do teste de Consistência Temporal 'a' nas 80 EMAs selecionadas gerou 80 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.3029% (≈ 239 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A875 – General Carneiro (PR), com 2.4838% (1960 horas) ([Tabela 11](#Tabela 11)).
</p>
...
t10 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc4a-summary-tavg-02h-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc4a-summary-tavg-03h-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
+ Para 3 hora: A aplicação do teste de Consistência Temporal 'a' nas 80 EMAs selecionadas gerou 80 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.3767% (≈ 297 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A875 – General Carneiro (PR), com 3.1288% (2469 horas) ([Tabela 12](#Tabela 12)).
</p>
...
t11 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc4a-summary-tavg-03h-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc4a-summary-tavg-06h-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
+ Para 6 hora: A aplicação do teste de Consistência Temporal 'a' nas 80 EMAs selecionadas gerou 72 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.1538% (≈ 121 horas), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A875 – General Carneiro (PR), com 1.6778% (1324 horas) ([Tabela 13](#Tabela 13)).
</p>
...
t12 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc4a-summary-tavg-06h-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
text.suspect(
  ...
  test_type = "hourly",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc4a-summary-tavg-12h-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
+ Para 12 hora: A aplicação do teste de Consistência Temporal 'a' nas 80 EMAs selecionadas gerou 1 EMA que apresentou dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.0013% (≈ 1 hora), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A875 – General Carneiro (PR), com 0.0013% (1 hora) ([Tabela 14](#Tabela 14)).
</p>
...
t13 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc4a-summary-tavg-12h-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "hours",
#  RETURN = "table")
  RETURN = "dt")
...
```{r, eval=FALSE, message=FALSE, echo=FALSE}
text.suspect(
  test_name = "Consistência Espacial",
  test_type = "daily",
  summary_link = summary_link,
  product3_link = '../../jbc-ic/output/qc5a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds')
```
<font size="3">
<p style='text-align: justify;'>
__(a)__ A aplicação do teste de Consistência Espacial 'a' nas 80 EMAs selecionadas gerou 70 EMAs que apresentaram dados considerados suspeitos. A média da porcentagem de dados considerados suspeitos nesse teste foi 0.0856% (≈ 3 dias), e a EMA que apresentou a maior porcentagem de dados considerados suspeitos foi a A842 – Nova Fátima (PR), com 0.365% (12 dias) ([Tabela 15](#Tabela 15)).
</p>

<font size="2">
<a id = "Tabela 04"> </a>
__Tabela 15__ – EMAs com maior número de dados considerados suspeitos no teste QC5a em ordem decrescente.

```{r, echo=FALSE}
t14 <- qc.results.table(
  DIRECTORY = '../../jbc-ic/output/qc5a-summary-tavg-data-inmet-2008-2016-4yrs-south.rds',
  EMAS = emas_sel,
  TIME = "days",
#  RETURN = "table")
  RETURN = "dt")
...
__Figura 17__ – Distribuição espacial das EMAs com dados considerados suspeitos no teste QC5a.
...
<font size="2">
__Tabela 16__ – Total absoluto de dados considerados suspeitos em cada EMA.
...
!![](../images/img_totEMA.png)

### <font size="3"> __3.7.2 Dados considerados suspeitos por QC__

<font size="2">
__Tabela 17__ – Total absoluto de dados considerados suspeitos em cada teste.
...
<font size="2">
__Tabela 18__ – Total absoluto de dados horários e diários considerados suspeitos por estado
...
_Nota:_
* total de dados horários suspeitos detectados nos testes qc1a, qc1b, qc2a, qc3a, qc3b, qc3c e qc4a (1h, 2h, 3h, 6h e 12h);
** total de dados diários suspeitos detectados nos testes qc3d, qc3e, qc3f e qc5a.
</p>
...
```{r, eval=FALSE, message=FALSE, echo=FALSE}
more_susp_hour <-
  suspect.by.site(DIRECTORY = directory, SUMMARY = emas_sel, TABLE = FALSE) %>%
  dplyr::select(site, state, name, suspect_hour, everything()) %>%
  dplyr::arrange(desc(suspect_hour))
more_susp_day <-
  suspect.by.site(DIRECTORY = directory, SUMMARY = emas_sel, TABLE = FALSE) %>%
  dplyr::select(site, state, name, suspect_day, everything()) %>%
  dplyr::arrange(desc(suspect_day))
more_susp_hour
more_susp_day

old_text <- "Somando os resultados dos testes, as estações que apresentaram o maior número de dados suspeitos nos testes horários foram: A875 – General Carneiro (PR) com 10895 horas, A845 – Morro Da Igreja/Bom Jardim da Serra (SC) com 8461 horas e A834 – Tramandaí (RS) com 7820 horas; nos testes diários foram: A807 – Curitiba (PR) com 27 dias, A851 – Italpóa (SC) com 22 dias e A824 – Icaraíma (PR) com 19 dias."
```

<font size="3">
<p style='text-align: justify;'>
Somando os resultados dos testes, as estações que apresentaram o maior número de dados considerados suspeitos nos testes horários foram: A875 – General Carneiro (PR) com 10895 horas, A845 – Morro Da Igreja/Bom Jardim da Serra (SC) com 8461 horas e A834 – Tramandaí (RS) com 7820 horas; nos testes diários foram: A807 – Curitiba (PR) e A824 – Icaraíma (PR) com 28 dias, A842 – Nova Fátima (PR) com 27 dias e A851 – Itapoá (SC) com 25 dias.
</p>
...
<a id = "FALLAHNEZHAD, 2012"> </a>
Fallahnezhad, MS. __Practical Concepts of Quality Control__, one chapter, In-Tech Open Press, December 19, 2012.
<http://www.intechopen.com/articles/show/title/new-models-of-acceptance-sampling-plans>

<a id = "rio"> </a>
Chung-hong Chan, Geoffrey CH Chan, Thomas J. Leeper, and Jason Becker (2018). rio: A Swiss-army knife for data file I/O. R package version 0.5.16. <https://cran.r-project.org/web/packages/rio/index.html>
